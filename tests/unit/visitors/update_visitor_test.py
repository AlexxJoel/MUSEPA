...
from modules.visitors.update_visitor.validations import validate_connection, validate_event_body, validate_payload
from modules.visitors.update_visitor.connect_db import get_db_connection,get_secrets
from modules.visitors.update_visitor.authorization import authorizate_user
...
class TestConnectDB(TestCase):
    @patch('modules.visitors.update_visitor.connect_db.psycopg2.connect')
    @patch('modules.visitors.update_visitor.connect_db.get_secrets')
