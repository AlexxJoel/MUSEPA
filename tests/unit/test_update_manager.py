...
from modules.managers.update_manager.app import validate_connection, validate_event_body, validate_payload
from modules.managers.update_manager.app import get_db_connection,get_secrets
from modules.managers.update_manager.app import authorizate_user
...
class TestConnectDB(TestCase):
    @patch('modules.managers.update_manager.app.psycopg2.connect')
    @patch('modules.managers.update_manager.app.get_secrets')
