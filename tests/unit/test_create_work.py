...
from modules.works.create_work.app import get_db_connection,get_secrets
from modules.works.create_work.app import authorizate_user
...
class TestConnectDB(TestCase):
    @patch('modules.works.create_work.app.psycopg2.connect')
    @patch('modules.works.create_work.app.get_secrets')
