...
class TestFindMuseum(TestCase):
    ...
    @patch("modules.museums.delete_museum.app.get_db_connection")
    @patch("modules.museums.delete_museum.app.authorizate_user")
    ...
    def test_delete_museum_success(self, mock_validate_event_path_params, mock_validate_connection, mock_authorizate_user, mock_get_db_connection):
    ...
    @patch("modules.museums.delete_museum.app.validate_connection")
    @patch("modules.museums.delete_museum.app.validate_event_path_params")
    def test_find_manager_not_found(self, mock_validate_event_path_params, mock_validate_connection, mock_authorizate_user, mock_get_db_connection):
        mock_authorizate_user.return_value = None
        mock_get_db_connection.return_value = self.mock_connection
