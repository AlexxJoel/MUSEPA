...
from modules.works.delete_work.connect_db import get_db_connection,get_secrets
from modules.works.delete_work.authorization import authorizate_user
...
class TestConnectDB(TestCase):
    @patch('modules.works.delete_work.connect_db.psycopg2.connect')
    @patch('modules.works.delete_work.connect_db.get_secrets')
